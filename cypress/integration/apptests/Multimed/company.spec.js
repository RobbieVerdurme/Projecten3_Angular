describe("Multimed company list", () => {
    ...
    it("Add company", function(){
        ...
        cy.get("[data-cy=CompanyContract]").type("21/16/2069")
        ...
        //go to list companies
        cy.visit("/bedrijf/lijst");
                
        //check if company is added
        cy.get("[data-cy=CompanyNameRow]").contains("TestCompany")
    ...
    it("Filter on company",function(){
        ...
        //type in the filter
        cy.get('[data-cy=CompanyFilter]').type('Jos');
    ...
    it("Company details", function(){
        ...
        cy.route({
            ...
            url: '/api/companies/1',
            status: 200,
            response: 'fixtures:comany.json'
        })
        
        //go to the user detail
        cy.get('[data-cy=CompanyNameRow]').first().click();
    ...
    it("Edit company", function(){
        ...
        cy.get('[data-cy=CompanyPostalcode]').contains("96400 GentForLife BelgieEEEEEEEEEEE");
